...
const Page = () => {
  return (
    <section className="flex flex-col mx-auto max-w-screen-xxl px-4 py-32 lg:flex lg:h-screen lg:items-center text-center">
      <div className="mb-10">
      ...
      <div className="mt-8 flex flex-wrap items-center justify-center gap-8">
        ...
        <div className="text-left">
          ...
          <a
            className="mb-4 block w-full rounded px-6 py-4 text-sm font-medium bg-white text-gray-700 shadow hover:text-red-700 focus:outline-none focus:ring active:text-red-500 sm:w-auto"
            href="#"
          >
          ...
          <a
            className="block w-full rounded px-6 py-4 text-sm font-medium bg-white text-gray-700 shadow hover:text-red-700 focus:outline-none focus:ring active:text-red-500 sm:w-auto"
            href="#"
          >
